 ...
 */
class tx_femanagement_view_qsm_einrichtungen_list extends tx_femanagement_view_form_list {
	...
	function getNewelemButtonTitle() {
		return 'Neue Einrichtung anlegen'; 
	}

}
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fe_management/view/qsm/class.tx_femanagement_view_qsm_einrichtungen_list.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fe_management/view/qsm/class.tx_femanagement_view_qsm_einrichtungen_list.php']);
}
