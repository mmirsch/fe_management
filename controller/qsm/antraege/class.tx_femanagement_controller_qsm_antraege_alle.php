 ...
 */
class tx_femanagement_controller_qsm_antraege_alle extends tx_femanagement_controller_qsm_antraege {
	...
	function initSingleView() {		
		...
		$this->formView = t3lib_div::makeInstance($viewClassName,
																							...
																							'single_left',
																							$this->eidViewHandler);
		$this->formView->setControllerName('tx_femanagement_controller_qsm_antraege_alle');																		
	...
	function showListView($aktuelleSeite) {
		...
		$filterListe[20] = $this->createFilterBereiche($sessionDaten,'Bereich');
		$filterListe[21] = $this->createFilterZeitraeume($sessionDaten,'Bezugssemester');
		$filterListe[22] = $this->createFilterAntragsstatus($sessionDaten,'Antragsstatus');
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fe_management/controller/qsm/antraege/class.tx_femanagement_controller_qsm_antraege_alle.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fe_management/controller/qsm/antraege/class.tx_femanagement_controller_qsm_antraege_alle.php']);
}
