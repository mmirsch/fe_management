 ...
 */
class tx_femanagement_controller_qsm_antraege_fina extends tx_femanagement_controller_qsm_antraege {
	...
	function initSingleView() {		
		...
		$this->formView = t3lib_div::makeInstance($viewClassName,
																							...
																							'single_left',
																							$this->eidViewHandler);
		$this->formView->setControllerName('tx_femanagement_controller_qsm_antraege_fina');																		
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fe_management/controller/qsm/antraege/class.tx_femanagement_controller_qsm_antraege_fina.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fe_management/controller/qsm/antraege/class.tx_femanagement_controller_qsm_antraege_fina.php']);
}
