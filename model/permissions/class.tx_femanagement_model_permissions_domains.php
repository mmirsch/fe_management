...
class tx_femanagement_model_permissions_domains	extends tx_femanagement_model {

	function __construct(&$piBase='',$storagePid=0) {
		parent::__construct($piBase,$storagePid,'tx_fe_management_permissions_domains');
	}
